  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <Link href="/admin/branding" className="rounded-2xl bg-background p-6 ring-1 ring-border transition hover:border-primary"><h2 className="font-bold text-text">Club branding &amp; details</h2><p className="mt-2 text-sm text-text-secondary">Club name, logo, website and the story behind the fundraiser.</p></Link>
