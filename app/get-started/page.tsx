...
const steps = [
  {
    ...
    body: "Register below with your email and a password. This account runs the competition — it is separate from playing. You'll need a one-time setup code from the platform team to actually create a fundraiser.",
  },
  {
